...
st.title("EA Sports '24 Player Analysis")
st.write(
...
if show_pie_chart:
    ...
    st.write("Check the box above to show the pie chart.")



# Add a checkbox to show the pie chart
show_pie_chart = st.checkbox("Show Pie Chart of Players Preferred Foot")
...
show_trend = st.checkbox('Show Trend of Average Overall Rating')
...
selected_teams = st.multiselect('Select a Team', players_data['club_name'].unique())
...
selected_players = st.sidebar.multiselect('Select a Player', players_data['long_name'].unique())

if selected_players:
    # Retrieve the information for the selected teams
    selected_player_info = players_data[players_data['long_name'].isin(selected_players)]
    ...
    st.warning("Please select one or more players from the dropdown to view their information and statistics.")
...
# Create a multiselect widget to choose one or more player
selected_teams = st.sidebar.multiselect("Select Teams", players_data['club_name'])
...
if selected_teams:
    ...
    st.warning("Please select one or more teams from the dropdown to view their information and statistics.")


# Create a multiselect widget to choose one or more countries
selected_countries = st.sidebar.multiselect("Select Countries", players_data['nationality_name'])
...
if selected_countries:
    ...
    st.subheader("Descriptive Statistics for Selected Countries")
    st.dataframe(country_numerical_stats.T)
else:
    st.warning("Please select one or more countries from the dropdown to view their information and statistics.")
...
# players_variables_to_plot = st.multiselect(
#     "Select attributes to plot",
#     selected_columns[2:],  # Exclude 'long_name'
# )

# Select attributes to plot
selected_variable = st.multiselect("Select a variable", players_data.columns[2:])
...
st.header("Top Players by Average Overall Rating Over Time")
st.write("Visualize the top players by their average overall rating for the past 9 years.")
...
st.header("Top Teams by Average Overall Rating of Players (2014 - 2023)")
st.write("Visualize the top Teams by their Players Average Overall Rating for the Past 9 years.")
...
selected_categories = st.multiselect('Select Category', players_data['position_category'].unique())
